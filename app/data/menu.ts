...
const mainProteinOptionsSeeEw: MenuOptionGroup = {
  id: "main-protein",
  name: "เลือกเนื้อสัตว์หลัก",
  englishName: "Main Protein",
  type: "single",
...
const mainProteinOptionsFriedRice: MenuOptionGroup = {
  id: "main-protein",
  name: "เลือกเนื้อสัตว์หลัก",
  englishName: "Main Protein",
  type: "single",
...
const foodTypeOptions: MenuOptionGroup = {
  ...
  options: [
    ...
    { id: "side-dish", name: "เป็นกับข้าว-Dish only", price: 20 },
  ],
};
...
const eggOptions: MenuOptionGroup = {
  ...
  options: [
    ...
    { id: "Century-eeg", name: "ไข่เยี่ยวม้า", englishName: "Century Egg", price: 10 },
  ],
};
...
const FriedriceNoSpicyOptions: MenuOptionGroup[] = [
  mainProteinOptionsFriedRice,
  addProteinOptions,
  extraOptions,
  eggOptions,
